...
class PortalDashboardService:
    ...
    def get_portal_home_summary(self, person_id: str, client_id: str) -> dict:
        ...
        return {
            ...
            "recent_documents": self.visibility.count_recent_visible_documents(person_id, client_id, recent_cutoff),
            "open_cases": self.visibility.count_open_visible_cases(person_id, client_id),
